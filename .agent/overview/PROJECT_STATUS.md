...
The display client app for LumenDS. This runs on remote Smart TVs (LG WebOS, Samsung Tizen, Android TV). It pairs with the dashboard, fetches the assigned playlist, caches media via Service Workers, and plays items in sequence. It handles device constraints, precise audio playback via Howler, and features a visual Lumia Debug log.

## Tech Stack

- Languages: JavaScript, JSX
- Frameworks: React, Vite
- Tools: TailwindCSS, Howler, Lucide React, Framer Motion
...
- Debug Log Toggle: Synchronized globally via Supabase Broadcast Channel and per-screen via `show_debug`.

## Recent Changes

### Debug Log Toggle Feature (2026-03-19)
